...
echo "#ENV" > ./.mvn.env.dev
echo DOCKER_USERNAME=$DOCKER_USERNAME >> ./.mvn.env.dev
echo GITHUB_USERNAME=$GITHUB_USERNAME >> ./.mvn.env.dev
echo GITHUB_EMAIL=$GITHUB_EMAIL >> ./.mvn.env.dev
echo GITHUB_REPOSITORY_ACCESS_TOKEN=$GITHUB_REPOSITORY_ACCESS_TOKEN >> ./.mvn.env.dev
echo GITHUB_PACKAGE_TOKEN=$GITHUB_PACKAGE_TOKEN >> ./.mvn.env.dev
echo GITHUB_ARTIFACTORY_URL=$GITHUB_ARTIFACTORY_URL >> ./.mvn.env.dev
echo SONAR_DB=$SONAR_DB >> ./.mvn.env.dev
echo SONAR_DB_USER=$SONAR_DB_USER >> ./.mvn.env.dev
echo SONAR_DB_PASSWORD=$SONAR_DB_PASSWORD >> ./.mvn.env.dev
echo SONAR_JDBC_URL=$SONAR_JDBC_URL >> ./.mvn.env.dev
echo JFROG_DB=$JFROG_DB >> ./.mvn.env.dev
echo JFROG_DB_USER=$JFROG_DB_USER >> ./.mvn.env.dev
echo JFROG_DB_PASSWORD=$JFROG_DB_PASSWORD >> ./.mvn.env.dev
echo JF_SHARED_DATABASE_TYPE=$JF_SHARED_DATABASE_TYPE >> ./.mvn.env.dev
echo JF_SHARED_DATABASE_DRIVER=$JF_SHARED_DATABASE_DRIVER >> ./.mvn.env.dev
echo JF_SHARED_DATABASE_URL=$JF_SHARED_DATABASE_URL >> ./.mvn.env.dev

mkdir -p ./ci/docker_compose/jfrog-postgresql \
...
docker compose --file mvn-docker-compose.yml --project-name mvn-dev --env-file .mvn.env.dev up --build -d