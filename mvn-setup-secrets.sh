...
create_secret "Sonar URL" "SONAR_URL" "http://localhost:9000"
...
create_secret "JFrog Artifactory snapshot URL" "JFROG_ARTIFACTORY_SNAPSHOT_URL" "http://localhost:8081/artifactory/pine-libs-snapshot"
create_secret "JFrog Artifactory release URL" "JFROG_ARTIFACTORY_RELEASE_URL" "http://localhost:8081/artifactory/pine-libs-release"
create_secret "JFrog Artifactory context URL" "JFROG_ARTIFACTORY_CONTEXT_URL" "http://localhost:8082/artifactory"
...
create_secret "Nexus Artifactory host URL" "NEXUS_ARTIFACTORY_HOST_URL" "http://localhost:8084"
create_secret "Nexus Artifactory snapshot URL" "NEXUS_ARTIFACTORY_SNAPSHOT_URL" "http://localhost:8084/repository/maven-snapshots"
create_secret "Nexus Artifactory release URL" "NEXUS_ARTIFACTORY_RELEASE_URL" "http://localhost:8084/repository/maven-releases"
